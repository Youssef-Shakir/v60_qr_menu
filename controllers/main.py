...
class V60MenuController(http.Controller):
        ...
        try:
            ...
            with reg.cursor() as cr:
                ...
                config_data = {
                    ...
                    'location_url': menu_config.location_url,
                    'music_request_url': menu_config.music_request_url,
                    'show_music_request': menu_config.show_music_request,
    ...
    def _render_landing_page(self, config_data, logo_base64, menu_url):
        ...
        if config_data.get('instagram_url'):
            instagram_html = f'''
            <a href="{config_data['instagram_url']}" target="_blank" class="v60-landing-btn v60-landing-btn-secondary">
                <svg class="v60-btn-icon" viewBox="0 0 24 24" fill="currentColor">
        ...
        location_html = ''
        if config_data.get('location_url'):
            location_html = f'''
            <a href="{config_data['location_url']}" target="_blank" class="v60-landing-btn v60-landing-btn-secondary">
                <svg class="v60-btn-icon" viewBox="0 0 24 24" fill="currentColor">
        ...
        music_html = ''
        if config_data.get('show_music_request'):
            if config_data.get('music_request_url'):
                music_html = f'''
                <a href="{config_data['music_request_url']}" target="_blank" class="v60-landing-btn v60-landing-btn-secondary">
                    <svg class="v60-btn-icon" viewBox="0 0 24 24" fill="currentColor">
                ...
                music_html = '''
                <div class="v60-landing-btn v60-landing-btn-coming-soon">
                    <svg class="v60-btn-icon" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z"/>
                    </svg>
                    <span>Music Request</span>
                    <span class="v60-coming-soon-badge">Coming Soon</span>
                </div>'''
...
<head>
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .v60-landing-btn-secondary:hover {{
            background: rgba(255,255,255,0.1);
            transform: translateY(-2px);
        }}
        .v60-landing-btn-coming-soon {{
            background: transparent;
            color: #666666;
            border-color: #444444;
            display: flex;
